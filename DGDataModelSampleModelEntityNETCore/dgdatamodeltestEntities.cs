...
{
    public partial class dgdatamodeltestEntities : DbContext
    {
        public dgdatamodeltestEntities()
        {
        }

        public dgdatamodeltestEntities(DbContextOptions<dgdatamodeltestEntities> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(ConfigurationManager.AppSettings["dgdatamodeltestConnectionString"]);
            }
        }
