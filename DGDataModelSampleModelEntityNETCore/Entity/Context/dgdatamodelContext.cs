...
namespace DG.DataModelSample.Model.Entity.Context
{
    public partial class dgdatamodelContext : DbContext
    {
        ...
        public dgdatamodelContext(DbContextOptions<dgdatamodelContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) { if (optionsBuilder.IsConfigured == false) optionsBuilder.UseSqlServer(System.Configuration.ConfigurationManager.AppSettings["dgdatamodelConnectionString"]); }
